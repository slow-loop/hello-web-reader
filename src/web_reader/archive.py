"""Archive — the file-layout contract for `output/`.
...
class Archive:
    ...
    def find_youtube(self, video_id: str) -> Optional[ArchivedItem]:
    ...
    def list_youtube(self, channel: str, since_date: str | None = None) -> list[ArchivedItem]:
        items = []
    ...
    def list_podcast(self, source_id: str, since_date: str | None = None) -> list[ArchivedItem]:
        items = [
    ...
    def list_articles(self, source_id: str, since_date: str | None = None) -> list[ArchivedItem]:
        items = [
    ...
    def _load(self, path: Path, source_type: str, url: str = "") -> ArchivedItem:
